...
export const uiCases: UICase[] = [
  {
    ...
    mockArtifact: {
      ...
      html: '<!doctype html><html><body><main><h1>Mock Artifact</h1><p>Generated by Playwright.</p></main></body></html>',
    },
    notes: [
  ...
  },
  {
    ...
    mockArtifact: {
      ...
      heading: 'Mock Deck',
      html: '<!doctype html><html><body><section class="slide"><h1>Mock Deck</h1></section></body></html>',
    },
    notes: ['Confirms the deck creation tab still routes into the same generation path.'],
  },
  {
  ...
  },
  {
    ...
    notes: ['Can reuse the generated HTML from prototype-basic, then revisit with a routed URL.'],
  },
  {
    id: 'file-upload-send',
  ...
  },
  {
    ...
    notes: ['Uses the FileWorkspace upload input rather than the chat composer upload path.'],
  },
  {
  ...
  },
  {
    ...
    notes: ['Covers the persisted tabs state stored by ProjectView and restored by FileWorkspace.'],
  },
  {
  ...
  },
  {
    ...
    mockArtifact: {
      ...
      html: '<!doctype html><html><body><main><h1>Stable Artifact</h1><p>Only one file should exist.</p></main></body></html>',
    },
    notes: [
