...
const CATEGORY = {
  ...
  // Backend & Data
  clickhouse: 'Backend & Data',
  composio: 'Backend & Data',
  hashicorp: 'Backend & Data',
  mongodb: 'Backend & Data',
  posthog: 'Backend & Data',
  sanity: 'Backend & Data',
  sentry: 'Backend & Data',
  ...
  ibm: 'Media & Consumer',
  nvidia: 'Media & Consumer',
  pinterest: 'Media & Consumer',
  playstation: 'Media & Consumer',
  spacex: 'Media & Consumer',
  spotify: 'Media & Consumer',
  theverge: 'Media & Consumer',
  uber: 'Media & Consumer',
  vodafone: 'Media & Consumer',
  wired: 'Media & Consumer',
  // Automotive
  bmw: 'Automotive',
  bugatti: 'Automotive',
  ferrari: 'Automotive',
...
function main(): void {
  ...
  try {
    ...
    console.error(
      'Did you extract the getdesign tarball? See scripts/sync-design-systems.ts header.'
    )
    process.exit(1)
  }
  ...
  for (const entry of manifest) {
    ...
    if (!cat) {
      skipped.push(`${brand} (unmapped category)`)
      continue
    }
