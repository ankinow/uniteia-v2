...
| global-curation-flywheel | conversion-tracker | `flywheel_output` → track deployed pages |
| global-curation-flywheel | performance-report | `flywheel_output` → measure flywheel results |
| global-curation-flywheel | self-improver | `flywheel_output` → analyze and improve pipeline |
| affiliate-program-search | global-curation-flywheel | `recommended_program` → product data for curation |
| trending-content-scout | global-curation-flywheel | `top_content` → benchmark for review content |
| competitor-spy | global-curation-flywheel | `competitor_gaps` → product opportunities to curate |
