...
**Generated:** 2026-05-28T13:42:58.594Z
**Source:** content-graph.generated (2026-05-28T12:04:22.753Z)
**Nodes:** 40
**Edges:** 608
...
|-----------|-------|------------|--------------|
| translated-as | 280 | 280 | 100% |
| belongs-to-niche | 200 | 30 | 15% (expected) |
| related-to | 128 | 96 | 75% (expected) |
...
|-------|------|---------|----------|-------|
| Magica: The AI Command Center | `magica-overview` | 50 | 15 | 65 |
| Getting Started with Magica | `magica-quickstart` | 50 | 15 | 65 |
| Building MCP Servers with Magica | `magica-mcp-server` | 50 | 15 | 65 |
| Tencent Cloud Deal Stack for Builders | `tencent-cloud-deal-stack-builders` | 50 | 15 | 65 |
| Tencent Cloud Deal Stack for Builders | `cnt_tecent_vm_benefits_2026_05` | 46 | 16 | 62 |
...
| `en-cnt_tecent_vm_benefits_2026_05` | Tencent Cloud Deal Stack for Builders | `cnt_tecent_vm_benefits_2026_05` | en | `apex` |
...
| `es-cnt_tecent_vm_benefits_2026_05` | Tencent Cloud Deal Stack para Creadores | `cnt_tecent_vm_benefits_2026_05` | es | `apex` |
...
| `ja-cnt_tecent_vm_benefits_2026_05` | Tencent Cloud Deal Stack for Builders | `cnt_tecent_vm_benefits_2026_05` | ja | `apex` |
...
| `pt-cnt_tecent_vm_benefits_2026_05` | Tencent Cloud Deal Stack: Cloud Barata para Builders | `cnt_tecent_vm_benefits_2026_05` | pt | `apex` |
...
| `zh-cnt_tecent_vm_benefits_2026_05` | Tencent Cloud Deal Stack for Builders | `cnt_tecent_vm_benefits_2026_05` | zh | `apex` |
...
| `de-cnt_tecent_vm_benefits_2026_05` | Tencent Cloud Deal Stack for Builders | `cnt_tecent_vm_benefits_2026_05` | de | `apex` |
...
| `fr-cnt_tecent_vm_benefits_2026_05` | Tencent Cloud Deal Stack for Builders | `cnt_tecent_vm_benefits_2026_05` | fr | `apex` |
...
| `it-cnt_tecent_vm_benefits_2026_05` | Tencent Cloud Deal Stack for Builders | `cnt_tecent_vm_benefits_2026_05` | it | `apex` |
| `it-tencent-cloud-deal-stack-builders` | Tencent Cloud Deal Stack per Creator | `tencent-cloud-deal-stack-builders` | it | `apex` |

---

*Report generated by scripts/generate-linkgraph-report.ts at 2026-05-28T13:42:58.602Z*
