...
**Generated:** 2026-06-05T21:11:21.450Z
**Source:** content-graph.generated (2026-06-05T20:58:40.598Z)
**Nodes:** 35
**Edges:** 513
...
|-----------|-------|------------|--------------|
| translated-as | 230 | 230 | 100% |
| belongs-to-niche | 175 | 30 | 17% (expected) |
| related-to | 108 | 96 | 89% (expected) |
...
|-------|------|---------|----------|-------|
| Magica: The AI Command Center | `magica-overview` | 45 | 15 | 60 |
| Getting Started with Magica | `magica-quickstart` | 45 | 15 | 60 |
| Building MCP Servers with Magica | `magica-mcp-server` | 45 | 15 | 60 |
| Tencent Cloud Deal Stack for Builders | `tencent-cloud-deal-stack-builders` | 45 | 15 | 60 |
| Tencent Cloud Deal Stack for Builders | `tecent-vm-benefits` | 36 | 11 | 47 |
...
| `en-tecent-vm-benefits` | Tencent Cloud Deal Stack for Builders | `tecent-vm-benefits` | en | `apex` |
...
| `es-tecent-vm-benefits` | Tencent Cloud Deal Stack para Creadores | `tecent-vm-benefits` | es | `apex` |
...
| `ja-tencent-cloud-deal-stack-builders` | ビルダーのためのTencent Cloudディールスタック | `tencent-cloud-deal-stack-builders` | ja | `apex` |
...
| `pt-tecent-vm-benefits` | Tencent Cloud Deal Stack: Cloud Barata para Builders | `tecent-vm-benefits` | pt | `apex` |
...
| `zh-tencent-cloud-deal-stack-builders` | 面向开发者的腾讯云交易堆栈 | `tencent-cloud-deal-stack-builders` | zh | `apex` |
...
*Report generated by scripts/generate-linkgraph-report.ts at 2026-06-05T21:11:21.454Z*
