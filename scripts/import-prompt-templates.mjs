...
function parseEntryBody(body, title, ctx, _featured) {
  ...
  const description = extractDescription(body) || extractBlockquoteSummary(body)
...
async function main() {
  ...
  for (const ctx of SOURCES) {
    ...
    const allPromptsBlock =
      sliceSection(md, /## (📋|🎬) All Prompts/m) || sliceSection(md, /## All Prompts/m)
