...
- Name: smoke.spec.ts >> language switcher persists cookie and reloads the same pathname
...
Expected pattern: /\/en\/test-article(?:\?.*)?$/
Received string:  "http://localhost:3000/en/test-article/"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    9 × unexpected value "http://localhost:3000/en/test-article/"
      ...
      - navigation [ref=e6]:
        ...
        - generic [ref=e10]:
          ...
          - link "Sobre" [ref=e12] [cursor=pointer]:
            - /url: /pt/about
          - button "Tópicos Toggle topics menu" [ref=e14]:
            - text: Tópicos
