...
- Location: tests/e2e/smoke.spec.ts:57:1
...
Locator: locator('[data-testid="error-code"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="error-code"]')
...
- paragraph [ref=e2]:
  - strong [ref=e3]: "404"
  - generic [ref=e4]: "Article not found: en/this-route-does-not-exist-at-all"
```
