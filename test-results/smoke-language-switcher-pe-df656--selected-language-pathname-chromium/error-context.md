...
- Location: tests/e2e/smoke.spec.ts:64:1
...
Locator: locator('[data-testid="lang-switcher-trigger"]')
Expected: visible
Error: strict mode violation: locator('[data-testid="lang-switcher-trigger"]') resolved to 2 elements:
    1) <button q:id="g" type="button" aria-haspopup="menu" aria-expanded="false" aria-label="Language" data-testid="lang-switcher-trigger" data-qwik-inspector="/src/components/lang-switcher/index.tsx:73:9" on:click="/src/components/lang-switcher/index.tsx_LangSwitcher_component_toggleDropdown_TZCVjT7SIAQ.js#LangSwitcher_component_toggleDropdown_TZCVjT7SIAQ[0 1]" class="lang-switcher-trigger appearance-none flex items-center gap-2 px-3 py-2 bg-void border border-action/30 rounded-none text-bone-primary hover:…>…</button> aka getByRole('banner').getByTestId('lang-switcher-trigger')
    2) <button q:id="o" type="button" aria-haspopup="menu" aria-expanded="false" aria-label="Language" data-testid="lang-switcher-trigger" data-qwik-inspector="/src/components/lang-switcher/index.tsx:73:9" on:click="/src/components/lang-switcher/index.tsx_LangSwitcher_component_toggleDropdown_TZCVjT7SIAQ.js#LangSwitcher_component_toggleDropdown_TZCVjT7SIAQ[0 1]" class="lang-switcher-trigger appearance-none flex items-center gap-2 px-3 py-2 bg-void border border-action/30 rounded-none text-bone-primary hover:…>…</button> aka getByRole('main').filter({ hasText: 'Skip to main' }).getByTestId('lang-switcher-trigger')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('[data-testid="lang-switcher-trigger"]')
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e92]: "Click-to-Source: Alt"
```
