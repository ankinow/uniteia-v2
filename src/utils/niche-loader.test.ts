...
function makeNiche(overrides: Partial<NicheConfig> = {}): NicheConfig {
  return {
    ...
    description: {
      ...
      de: 'Autonome KI-Systeme, die wahrnehmen,推理en und handeln, um Ziele zu erreichen.',
      it: 'Sistemi di IA autonomi che percepiscono, ragionano e agiscono per raggiungere obiettivi.',
    ...
    const niches: NichesConfig = [
      makeNiche(),
      {
        ...
        description: {
          ...
          de: 'Großangelegte Modelle, die menschliche Sprache verstehen und generieren.',
          it: 'Modelli su larga scala che comprendono e generano linguaggio umano.',
