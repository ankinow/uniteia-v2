...
export const SiteShell = component$(() => {
  ...
  return (
    <div class="site-shell min-h-screen flex flex-col bg-void text-bone-primary">
      <a
        href="#main-content"
        class="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-brand-primary focus:text-void focus:rounded"
      >
