  ...
  return (
    ...
    >
      ...
      <g font-family="JetBrains Mono, monospace" font-size="7" fill="oklch(60% 0.02 75)">
        ...
        <text x="105" y="116" text-anchor="middle">
          5s
        </text>
        <text x="180" y="116" text-anchor="middle">
          ~9s p50
        </text>
        <text x="365" y="116" text-anchor="end" fill="oklch(65% 0.18 30)">
          ~30s p99
        </text>
      </g>
        ...
        {[
          ...
          <g key={step.label}>
            ...
            <text
              ...
              text-anchor="middle"
              font-weight="bold"
              fill="oklch(90% 0.02 75)"
            >
              {step.title}
            </text>
            <text x={step.x} y="56" text-anchor="middle" font-size="8" fill="oklch(72% 0.165 80)">
              {step.time}
            </text>
            <text x={step.x} y="68" text-anchor="middle" font-size="7" fill="oklch(60% 0.02 75)">
              {step.tip}
            </text>
          </g>
        ))}
      ...
      <g font-family="JetBrains Mono, monospace" font-size="7" fill="oklch(65% 0.18 30)">
        <text x="50" y="148" font-weight="bold" fill="oklch(90% 0.02 75)">
          PITFALLS
        </text>
        <text x="50" y="160">
          • OAuth scope mismatch (key from us-east, model in eu-west)
        </text>
        <text x="50" y="170">
          • Free tier 429 quota — wait or upgrade
        </text>
        <text x="50" y="180">
          • Cold start: 3-8s on first provider call (connection pool warm-up)
        </text>
        <text x="50" y="190">
          • Stream vs batch: stream returns 1st token in ~150ms, full response in 800ms
        </text>
      </g>
