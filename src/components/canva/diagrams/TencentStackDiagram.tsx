    ...
    >
      ...
      <g font-family="JetBrains Mono, monospace" font-size="10" fill="oklch(90% 0.02 75)">
        <rect
          ...
          stroke-width="2"
        />
        <text x="220" y="50" text-anchor="middle" font-weight="bold" fill="oklch(78% 0.2 145)">
          EDGEONE
        </text>
        <text x="220" y="63" text-anchor="middle" font-size="8" fill="oklch(60% 0.02 75)">
          280+ PoPs · HTTP/3 · WAF
        </text>
        <text x="220" y="75" text-anchor="middle" font-size="8" fill="oklch(60% 0.02 75)">
          Bot manager · 0.06 USD/GB
        </text>
      </g>
      ...
      <g font-family="JetBrains Mono, monospace" font-size="10" fill="oklch(90% 0.02 75)">
        <rect
          ...
          stroke-width="2"
        />
        <text x="220" y="116" text-anchor="middle" font-weight="bold" fill="oklch(72% 0.165 80)">
          CVM
        </text>
        <text x="220" y="130" text-anchor="middle" font-size="8" fill="oklch(60% 0.02 75)">
          S5 · SA2 AMD · GN7 GPU
        </text>
        <text x="220" y="140" text-anchor="middle" font-size="8" fill="oklch(60% 0.02 75)">
          Spot: up to 90% off (interrupt risk)
        </text>
        <text x="220" y="150" text-anchor="middle" font-size="8" fill="oklch(60% 0.02 75)">
      ...
      <g font-family="JetBrains Mono, monospace" font-size="10" fill="oklch(90% 0.02 75)">
        <rect
          ...
          stroke-width="2"
        />
        <text x="220" y="190" text-anchor="middle" font-weight="bold" fill="oklch(75% 0.18 200)">
          LIGHTHOUSE
        </text>
        <text x="220" y="204" text-anchor="middle" font-size="8" fill="oklch(60% 0.02 75)">
          managed VPS · 1-click apps (WordPress, Ghost, n8n, ntfy)
        </text>
        <text x="220" y="214" text-anchor="middle" font-size="8" fill="oklch(60% 0.02 75)">
          snapshot + backup · API · auto-renew
        </text>
        <text x="220" y="224" text-anchor="middle" font-size="8" fill="oklch(60% 0.02 75)">
          bundle with EdgeOne → 30% off (12mo)
        </text>
      </g>
      ...
      <g font-family="JetBrains Mono, monospace" font-size="9" fill="oklch(65% 0.18 30)">
        ...
        <text x="14" y="60" text-anchor="end">
          $0.06/GB
        </text>
        <text x="14" y="100" text-anchor="end">
          $20+
        </text>
        <text x="14" y="125" text-anchor="end" font-size="7" fill="oklch(60% 0.02 75)">
          + spot 90%↓
        </text>
        <text x="14" y="190" text-anchor="end">
          $3
        </text>
        <text x="14" y="248" text-anchor="end" font-size="7" fill="oklch(60% 0.02 75)">
          /mo
        </text>
      </g>
      ...
      <g font-family="JetBrains Mono, monospace" font-size="8" fill="oklch(60% 0.02 75)">
        <text x="220" y="258" text-anchor="middle" font-weight="bold" fill="oklch(90% 0.02 75)">
          SOTA PATTERNS
        </text>
        <text x="220" y="270" text-anchor="middle">
          Lighthouse + EdgeOne = static site at $3/mo · CVM Spot = batch at 90%↓
        </text>
      </g>
    </svg>
  )
