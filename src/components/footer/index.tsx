...
export const Footer = component$<FooterProps>(({ class: classList }) => {
  ...
  return (
    <div
      class={['footer-inner', 'hud-panel', 'py-8 px-4 md:px-8', 'text-sm text-bone-muted', classList]}
      data-testid="footer"
    >
      <div class="footer-content mx-auto flex max-w-7xl flex-col gap-6">
        ...
        <div class="flex flex-col items-center justify-between gap-4 md:flex-row">
          ...
          <nav class="footer-links flex flex-wrap gap-4 justify-center md:justify-end" data-testid="footer-links">
            <a href="/privacy" class="text-bone-muted transition-colors duration-200 hover:text-action">
              {t.footer.links.privacy}
            </a>
            <a href="/terms" class="text-bone-muted transition-colors duration-200 hover:text-action">
          ...
          <div class="footer-language flex items-center gap-2 text-xs" data-testid="footer-language">
