...
/**
 * SourceLedger - External reference links display component
 *
 * Renders referral links as an accessible, SEO-safe list.
 * All external links use rel="noopener noreferrer nofollow" for:
 * - noopener: prevents window.opener access (security)
 * - noreferrer: hides referrer header (privacy)
 * - nofollow: instructs search engines not to pass link equity (SEO)
 *
 * Maximum 5 links per article per schema constraints.
...
export const SourceLedger = component$<SourceLedgerProps>(props => {
  ...
  return (
    ...
    >
      <h2 class="mb-3 text-sm font-semibold uppercase tracking-wider text-bone-muted">Sources</h2>
