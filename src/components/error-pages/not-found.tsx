  ...
  return (
    ...
    >
      ...
      <a
        ...
        class="inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-cyan hover:bg-cyan-hi text-void font-bold rounded-full shadow-sm hover:shadow active:scale-95 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan focus-visible:ring-offset-2 z-10"
