    ...
    <div class="trending-section space-y-8">
      ...
      {loading.value && (
        <div class="flex gap-3 animate-pulse">
          {[1, 2, 3].map(i => (
            <div key={i} class="w-[220px] h-32 bg-white/10 rounded-sm" />
          ))}
        </div>
      )}
      ...
      {error.value && !loading.value && (
        <div class="text-sm text-[oklch(0.55_0.15_30)] bg-white/10 p-3 rounded-sm border border-[oklch(0.55_0.15_30/0.3)]">
          ⚠️ {error.value}
        </div>
      )}
