...
export const useHomepageData = routeLoader$<HomepageProjection>(async () => {
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-10">
          ...
          <div class="text-center">
            ...
            <div class="flex flex-col gap-2">
              <a href="/signals" class="text-xs text-bone/50 hover:text-neon-cyan transition-colors no-underline">
                {t.nav.topics}
              </a>
              <a href="/verdict" class="text-xs text-bone/50 hover:text-neon-cyan transition-colors no-underline">
                {t.editorial.verdictLabel}
              </a>
              <a href="/search" class="text-xs text-bone/50 hover:text-neon-cyan transition-colors no-underline">
                {t.nav.search}
              </a>
            </div>
          </div>
          <div class="text-center sm:text-right">
            ...
            <div class="flex flex-col gap-2">
              <a href="/privacy" class="text-xs text-bone/50 hover:text-neon-cyan transition-colors no-underline">
                {t.footer.links.privacy}
              </a>
              <a href="/terms" class="text-xs text-bone/50 hover:text-neon-cyan transition-colors no-underline">
