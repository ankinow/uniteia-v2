...
export const en: TranslationStrings = {
  ...
  footer: {
    ...
    builtWith: 'Built with PA∞ SOTA',
    tagline: 'Autonomous Engineering',
    links: {
  ...
  article: {
    ...
    canvaMagicaProduction: {
      ...
      pillBudgetGate: 'Budget Gate',
      pillSloRouter: 'SLO Router',
      pillToolInjection: 'Tool Injection',
      pillGlobalEdge: 'Global Edge',
      pillZeroLatency: 'Zero-Latency',
      pillEdgeOne: 'EdgeOne WAF',
      pillLighthouse: 'Lighthouse CVM',
      validationCompliance: 'PA∞ SOTA Compliance',
      flowSources: 'SOURCES',
  ...
  curation: {
    trendingHeader: 'Trending AI & Robotics',
    topReposHeader: 'Top Repos da Semana',
    newsHeader: 'Notícias do Dia',
    randomArticleHeader: 'Artigo Aleatório',
    randomArticleAria: 'Random article: {title}',
    emptyMessage: 'Trending unavailable — check back later',
    errorMessage: 'Failed to load trending data',
    retryAria: 'Retry loading trending data',
    relativeNow: 'now',
    relativeUpdated: 'updated',
    noDescription: 'No description',
    bauhaus: {
      pulseCheck: 'Pulse Check',
      trendingHeader: 'Trending\nIntelligence',
      liveStream: 'Live Stream',
      globalSignals: 'Global Signals',
      signalLost: 'Signal Lost',
      noSignals: 'No Signals',
      recommendedInsight: 'Recommended Insight',
      goCTA: 'GO →',
      status: {
      ...
      fallback: {
        message1: 'Live feed unavailable ({err}). Showing curated content instead.',
        message2: 'Live feed rate-limited. Showing curated content instead.',
      },
      card: {
        repo: 'REPO',
        stars: 'Stars',
