...
export const fr: TranslationStrings = {
  ...
  footer: {
    ...
    builtWith: 'Construit avec PA∞ SOTA',
    tagline: 'Ingénierie Autonome',
    links: {
  ...
  article: {
    ...
    canvaMagicaProduction: {
      ...
      pillBudgetGate: 'Porte Budgétaire',
      pillSloRouter: 'Routeur SLO',
      pillToolInjection: "Injection d'Outils",
      pillGlobalEdge: 'Edge Global',
      pillZeroLatency: 'Zéro Latence',
      pillEdgeOne: 'EdgeOne WAF',
      pillLighthouse: 'Lighthouse CVM',
      validationCompliance: 'Conformité PA∞ SOTA',
      flowSources: 'SOURCES',
  ...
  search: {
    label: 'Rechercher des sujets, articles',
...
<p>Pour toute question relative aux présentes Conditions Générales d'Utilisation, pour signaler un contenu que vous estimez inapproprié, ou pour toute demande d'information légale, vous pouvez nous contacter par email à legal@uniteia.org. Nous nous efforçons de répondre à toute demande dans un délai de 5 jours ouvrés. UniTeia est exploitée par l'association UniTeia, immatriculée au Registre du Commerce et des Sociétés de Paris sous le numéro SIRET à venir, dont le siège social est situé 7 Rue de l'Innovation, 75000 Paris, France. Directeur de la publication : le président de l'association. Hébergeur : Cloudflare Inc., 101 Townsend Street, San Francisco, CA 94107, États-Unis. Dernière mise à jour : juin 2026.</p>`,
  ...
  curation: {
    trendingHeader: 'Tendances IA & Robotique',
    topReposHeader: 'Top Repos de la Semaine',
    newsHeader: 'Actualités du Jour',
    randomArticleHeader: 'Article Aléatoire',
    randomArticleAria: 'Article aléatoire : {title}',
    emptyMessage: 'Tendances indisponibles — revenez plus tard',
    errorMessage: 'Échec du chargement des tendances',
    retryAria: 'Réessayer de charger les données',
    relativeNow: 'maintenant',
    relativeUpdated: 'mis à jour',
    noDescription: 'Pas de description',
    bauhaus: {
      pulseCheck: 'Vérification du Pouls',
      trendingHeader: 'Intelligence des\nTendances',
      liveStream: 'Flux en Direct',
      globalSignals: 'Signaux Mondiaux',
      signalLost: 'Signal Perdu',
      noSignals: 'Aucun Signal',
      recommendedInsight: 'Aperçu Recommandé',
      goCTA: 'ALLER →',
      status: {
        connecting: 'Connexion...',
        error: 'Erreur',
        staticCache: 'Cache Statique',
        noData: 'Pas de Données',
        synchronized: 'Synchronisé',
      },
      fallback: {
        message1: 'Flux en direct indisponible ({err}). Affichage du contenu curé.',
        message2: 'Flux en direct limité. Affichage du contenu curé.',
      },
      card: {
        repo: 'DÉPÔT',
        stars: 'Étoiles',
