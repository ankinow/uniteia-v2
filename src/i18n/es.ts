...
export const es: TranslationStrings = {
  ...
  footer: {
    ...
    builtWith: 'Construido con PA∞ SOTA',
    tagline: 'Ingeniería Autónoma',
    links: {
  ...
  article: {
    ...
    canvaMagicaProduction: {
      ...
      pillBudgetGate: 'Control de Presupuesto',
      pillSloRouter: 'Enrutador SLO',
      pillToolInjection: 'Inyección de Herramientas',
      pillGlobalEdge: 'Borde Global',
      pillZeroLatency: 'Latencia Cero',
      pillEdgeOne: 'EdgeOne WAF',
      pillLighthouse: 'Lighthouse CVM',
      validationCompliance: 'Cumplimiento PA∞ SOTA',
      flowSources: 'FUENTES',
  ...
  curation: {
    trendingHeader: 'Tendencias en IA y Robótica',
    topReposHeader: 'Top Repos de la Semana',
    newsHeader: 'Noticias del Día',
    randomArticleHeader: 'Artículo Aleatorio',
    randomArticleAria: 'Artículo aleatorio: {title}',
    emptyMessage: 'Tendencias no disponibles — vuelve más tarde',
    errorMessage: 'Error al cargar datos de tendencias',
    retryAria: 'Reintentar cargar datos',
    relativeNow: 'ahora',
    relativeUpdated: 'actualizado',
    noDescription: 'Sin descripción',
    bauhaus: {
      pulseCheck: 'Chequeo de Pulso',
      trendingHeader: 'Inteligencia de\nTendencias',
      liveStream: 'Transmisión en Vivo',
      globalSignals: 'Señales Globales',
      ...
      status: {
        ...
        error: 'Error',
        staticCache: 'Caché Estática',
        noData: 'Sin Datos',
        synchronized: 'Sincronizado',
      },
      fallback: {
        message1: 'Feed en vivo no disponible ({err}). Mostrando contenido curado.',
        message2: 'Feed en vivo con límite de tasa. Mostrando contenido curado.',
      },
      card: {
        repo: 'REPO',
        stars: 'Estrellas',
