...
export const de: TranslationStrings = {
  ...
  canva: {
    hero: {
      title: 'Entwerfen Sie mit Gedankenschnelle',
      subtitle: 'Eine visuelle Leinwand für KI-gestützte redaktionelle Workflows',
      cta: 'Jetzt erkunden',
    },
    concept: {
      central: 'Eine Leinwand, viele Formen — komponierbar nach Absicht',
      satellite: {
        1: 'Knoten ziehen, ablegen und neu verdrahten ohne die Seite zu verlassen',
        2: 'Jede Änderung spiegelt sich sofort in 8 Sprachen wider',
      },
    },
    code: {
      step: {
        1: {
          ...
          body: 'Beginnen Sie mit einer Absicht in natürlicher Sprache. Die Leinwand macht daraus strukturierte Knoten.',
        },
        2: {
          title: 'Modell-Router verbinden',
        },
      },
    },
    compare: {
      option: {
        a: 'Statisches Design-Tool',
        b: 'UniTeia Canva',
      },
      decision: {
        yes: 'Passt zu unserer redaktionellen Pipeline',
        no: 'Falsches Werkzeug für mehrsprachige KI-Workflows',
      },
    },
    timeline: {
      milestone: {
        1: '2026 Q1 — Canva Magica private Alpha',
        2: '2026 Q3 — Öffentlicher Launch mit 8-Sprachen-Parität',
      },
    },
    summary: {
      takeaway: {
        1: 'Eine einzige Leinwand, die alle Sprachen spricht, in denen Sie veröffentlichen',
        2: 'Visuelle Komposition ohne Verzicht auf strukturierte Daten',
      },
      nextstep:
        'Öffnen Sie die Leinwand, platzieren Sie Ihre erste Form und veröffentlichen Sie in 8 Sprachen',
    },
  },
}
