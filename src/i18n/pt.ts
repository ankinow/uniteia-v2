...
export const pt: TranslationStrings = {
  ...
  canva: {
    hero: {
      title: 'Desenhe na velocidade do pensamento',
      subtitle: 'Uma tela visual para fluxos editoriais com IA',
      cta: 'Comece a explorar',
    },
    concept: {
      central: 'Uma tela, várias formas — combinável por intenção',
      satellite: {
        1: 'Arraste, solte e reconecte nós sem sair da página',
        2: 'Cada alteração reflete em 8 idiomas simultaneamente',
      },
    },
    code: {
      step: {
        1: {
          title: 'Definir o prompt',
          body: 'Comece com uma intenção em linguagem natural. A tela transforma em nós estruturados.',
        },
        2: {
          title: 'Conectar o roteador de modelos',
        },
      },
    },
    compare: {
      option: {
        a: 'Ferramenta de design estática',
        b: 'UniTeia Canva',
      },
      decision: {
        yes: 'Serve ao nosso pipeline editorial',
        no: 'Ferramenta errada para fluxos IA multilíngues',
      },
    },
    timeline: {
      milestone: {
        1: '2026 T1 — Canva Magica alfa privado',
        2: '2026 T3 — Lançamento público com paridade em 8 idiomas',
      },
    },
    summary: {
      takeaway: {
        1: 'Uma tela que fala todos os idiomas nos quais você publica',
        2: 'Composição visual sem abrir mão dos dados estruturados',
      },
      nextstep: 'Abra a tela, solte sua primeira forma e publique em 8 idiomas',
    },
  },
}
