...
export const pt: TranslationStrings = {
  ...
  footer: {
    ...
    builtWith: 'Construído com PA∞ SOTA',
    tagline: 'Engenharia Autônoma',
    links: {
  ...
  article: {
    ...
    canvaMagicaProduction: {
      ...
      pillBudgetGate: 'Portão de Orçamento',
      pillSloRouter: 'Roteador SLO',
      pillToolInjection: 'Injeção de Ferramentas',
      pillGlobalEdge: 'Borda Global',
      pillZeroLatency: 'Latência Zero',
      pillEdgeOne: 'EdgeOne WAF',
      pillLighthouse: 'Lighthouse CVM',
      validationCompliance: 'Conformidade PA∞ SOTA',
      flowSources: 'FONTES',
  ...
  homepage: {
    ...
    footerMadeWith:
      'Feito com ❤️ para IA descentralizada pela equipe UniTeia & LERMF. Empoderando vibe-coders e construtores em todo o mundo.',
  },
  onboarding: {
    step1: {
      title: 'Feito com paixão para a comunidade.',
      subtitle: 'Filtramos o ruído para você focar no vibe-coding.',
      desc: 'Nossa equipe UniTeia & LERMF mergulha diariamente em milhares de fontes, curando os melhores insights com amor e dedicação. Para que você foque em construir.',
    },
    step2: {
      title: 'Curadoria humana, potencializada pela tecnologia.',
      cards: [
        {
          label: 'Pesquisa',
          desc: 'Selecionamos e avaliamos fontes brutas com cuidado para garantir confiança absoluta.',
        },
        {
          label: 'Verificação',
          desc: 'Cada afirmação é checada com dedicação de acordo com os padrões da nossa comunidade.',
        },
        {
          label: 'Entrega',
          desc: 'Conteúdo formatado de forma linda e localizado especialmente para você.',
        },
      ],
    },
    step3: {
  ...
  sketchnote: {
    template01: {
      ...
      footer:
        'Criado com ❤️ para aprendizes, vibe-coders e construtores. Pela equipe UniTeia & LERMF.',
    },
    template02: {
  ...
  curation: {
    trendingHeader: 'Tendências em IA & Robótica',
    topReposHeader: 'Top Repos da Semana',
    newsHeader: 'Notícias do Dia',
    randomArticleHeader: 'Artigo Aleatório',
    randomArticleAria: 'Artigo aleatório: {title}',
    emptyMessage: 'Tendências indisponíveis — volte mais tarde',
    errorMessage: 'Falha ao carregar dados de tendências',
    retryAria: 'Tentar carregar dados novamente',
    relativeNow: 'agora',
    relativeUpdated: 'atualizado',
    noDescription: 'Sem descrição',
    bauhaus: {
      pulseCheck: 'Verificação de Pulso',
      trendingHeader: 'Inteligência em Tendências',
      liveStream: 'Transmissão ao Vivo',
      globalSignals: 'Sinais Globais',
      signalLost: 'Sinal Perdido',
      noSignals: 'Sem Sinais',
      recommendedInsight: 'Insight Recomendado',
      goCTA: 'IR →',
      status: {
        connecting: 'Conectando...',
        error: 'Erro',
        staticCache: 'Cache Estático',
        noData: 'Sem Dados',
        synchronized: 'Sincronizado',
      },
      fallback: {
        message1: 'Feed ao vivo indisponível ({err}). Exibindo conteúdo curado.',
        message2: 'Feed ao vivo com limite de taxa. Exibindo conteúdo curado.',
      },
      card: {
        repo: 'REPO',
        stars: 'Estrelas',
