...
export const it: TranslationStrings = {
  ...
  footer: {
    ...
    builtWith: 'Costruito con PA∞ SOTA',
    tagline: 'Ingegneria Autonoma',
    links: {
  ...
  article: {
    ...
    canvaMagicaProduction: {
      ...
      pillBudgetGate: 'Cancello di Budget',
      pillSloRouter: 'Router SLO',
      pillToolInjection: 'Iniezione Strumenti',
      pillGlobalEdge: 'Edge Globale',
      pillZeroLatency: 'Zero Latenza',
      pillEdgeOne: 'EdgeOne WAF',
      pillLighthouse: 'Lighthouse CVM',
      validationCompliance: 'Conformità PA∞ SOTA',
      flowSources: 'FONTI',
  ...
  search: {
    ...
    label: 'Cerca argomenti, articoli',
  ...
  curation: {
    trendingHeader: 'Tendenze IA & Robotica',
    topReposHeader: 'Migliori Repo della Settimana',
    newsHeader: 'Notizie del Giorno',
    randomArticleHeader: 'Articolo Casuale',
    randomArticleAria: 'Articolo casuale: {title}',
    emptyMessage: 'Tendenze non disponibili — riprova più tardi',
    errorMessage: 'Caricamento dati tendenze fallito',
    retryAria: 'Riprova a caricare i dati',
    relativeNow: 'ora',
    relativeUpdated: 'aggiornato',
    noDescription: 'Nessuna descrizione',
    bauhaus: {
      pulseCheck: 'Controllo del Polso',
      trendingHeader: 'Intelligenza delle\nTendenze',
      liveStream: 'Streaming Live',
      globalSignals: 'Segnali Globali',
      signalLost: 'Segnale Perso',
      noSignals: 'Nessun Segnale',
      recommendedInsight: 'Insight Consigliato',
      goCTA: 'VAI →',
      status: {
        connecting: 'Connessione...',
        error: 'Errore',
        staticCache: 'Cache Statica',
        noData: 'Nessun Dato',
        synchronized: 'Sincronizzato',
      },
      fallback: {
        message1: 'Feed live non disponibile ({err}). Mostro contenuti curati.',
        message2: 'Feed live limitato. Mostro contenuti curati.',
      },
      card: {
        repo: 'REPO',
        stars: 'Stelle',
